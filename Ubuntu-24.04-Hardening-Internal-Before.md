# Vulnerability Scan Report (Internal Before Hardening)
...
* 
**Report Name:** Ubuntu-24.04-Hardening-Internal-Before 


* 
**Scan Date:** Thu, 04 Jun 2026 20:34:14 EDT 
...
The internal credentialed scan performed against the target host detected a total of **61 findings**. This includes **1 Low-severity** vulnerability and **60 Informational** findings. No Critical, High, or Medium risk vulnerabilities were identified.

As an authenticated internal scan, Nessus successfully logged into the host via SSH using valid credentials, enabling an in-depth collection of local system configuration markers and software inventory.
...
The following table lists the plugins triggered during the pre-hardening internal scan.
...
| **INFO** | N/A | 25220 | TCP/IP Timestamps Supported 
 ...
 |
| **INFO** | N/A | 110095 | Target Credential Issues by Authentication Protocol - No Issue Found 
